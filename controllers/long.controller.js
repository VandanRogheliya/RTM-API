...
exports.findAll = (req, res) => {
	LongTerm.getAll(req.user.id, (err, data) => resultHandler.findAll(err, data, req, res))
}

// Find a single Goal with a 'id'
exports.findOne = (req, res) => {
	LongTerm.findById(req.params.id, req.user.id, (err, data) => resultHandler.findOne(err, data, req, res))
}
...
exports.update = (req, res) => {
	...
	LongTerm.updateById(req.params.id, req.user.id, new LongTerm(req.body), (err, data) =>
...
exports.delete = (req, res) => {
	LongTerm.remove(req.params.id, req.user.id, (err, data) => resultHandler.delete(err, data, req, res))
}

// Delete all Goals from the database.
exports.deleteAll = (req, res) => {
	LongTerm.removeAll(req.user.id, (err, data) => resultHandler.deleteAll(err, data, req, res))
}
