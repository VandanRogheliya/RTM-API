...
exports.findAll = (req, res) => {
	Week.getAll(req.user.id, (err, data) => resultHandler.findAll(err, data, req, res))
}

// Find a single Goal with a 'id'
exports.findOne = (req, res) => {
	Week.findById(req.params.id, req.user.id, (err, data) => resultHandler.findOne(err, data, req, res))
}
...
exports.update = (req, res) => {
	...
	Week.updateById(req.params.id, req.user.id, new Week(req.body), (err, data) => resultHandler.updateById(err, data, req, res))
}

// Delete a Goal with the specified 'id' in the request
exports.delete = (req, res) => {
	Week.remove(req.params.id, req.user.id, (err, data) => resultHandler.delete(err, data, req, res))
}

// Delete all Goals from the database.
exports.deleteAll = (req, res) => {
	Week.removeAll(req.user.id, (err, data) => resultHandler.deleteAll(err, data, req, res))
}
